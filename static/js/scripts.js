...
mr = (function (mr, $, window, document){
    ...
    var documentReady = function($){
	    ...
	    $('.background-image-holder').each(function() {
	        ...
	        $(this).css('background', 'url("' + imgSrc + '")').css('background-repeat','no-repeat').css('opacity','1');
	    });
    };
            ...
            if(typeof window.google.maps !== "undefined"){
                ...
                jQuery('.gmaps-active').each(function(){
                    var mapElement    = this,
                        ...
                        markerImage   = typeof mapInstance.attr('data-marker-image') !== typeof undefined ? mapInstance.attr('data-marker-image'): '/stellar_attendance/static/images/mapmarker.png',
